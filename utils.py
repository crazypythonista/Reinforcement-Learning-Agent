...
def Normalizing(df_original):
    ...
    #df = df['Open','High','Low','Close', 'Volume','sma7','sma25', 'sma99', 'bb_bbm', 'bb_bbh', 'bb_bbl', 'psar', 'MACD', 'RSI']
    #column_names = df.values.tolist()
    #column_names = pd.to_numeric(column_names,downcast="float")
    column_names = float(df)
